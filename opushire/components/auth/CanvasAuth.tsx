...
export const SignInPage = ({ className, mode = 'login' }: SignInPageProps & { mode?: 'login' | 'register' }) => {
                                ...
                                {step === "details" ? (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">{mode === 'login' ? 'Welcome Back' : 'Welcome Developer'}</h1>
                                            <p className="text-[1.3rem] text-white/70 font-light">{mode === 'login' ? 'Sign in to OpusHire' : 'Create an Account'}</p>
                                        </div>
                                            ...
                                            <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
                                                {mode === 'register' && (
                                                    <input
                                                        ...
                                                        className="w-full backdrop-blur-[1px] text-white border-1 border-white/10 rounded-xl py-3 px-4 focus:outline-none focus:border focus:border-white/30"
                                                        required
                                                    />
                                                )}
                                                <input
                                                ...
                                                <button
                                                    type="submit"
                                                    className="w-full font-bold text-black mt-4 h-11 flex items-center justify-center rounded-xl bg-white hover:bg-white/90 transition-colors group overflow-hidden"
                                                >
                                                    {mode === 'login' ? 'Sign In' : 'Sign Up'}
                                                </button>
                                            </form>
                                            <Link href={mode === 'login' ? '/register' : '/login'} className="block mt-4 text-white/60 hover:text-white transition-colors">
                                    ...
                                    >
                                        ...
                                        <Link href="/dashboard" className="w-full block text-center rounded-xl bg-white text-black font-bold h-11 leading-11 hover:bg-white/90 transition-colors">
