...
export default function LoginPage() {
    ...
    return (
        <div className="bg-background-dark text-slate-100 min-h-screen flex flex-col font-display selection:bg-primary/30">
            ...
            {/* Top Navigation Bar */}
            <header className="w-full px-6 py-6 lg:px-20 flex items-center justify-between border-b border-primary/10 backdrop-blur-md z-50">
                <Link href="/" className="flex items-center gap-3">
                    <div className="size-8 bg-primary rounded-lg flex items-center justify-center text-white shadow-[0_0_15px_rgba(17,82,212,0.5)]">
                        <span className="material-symbols-outlined text-xl">fluid</span>
                    </div>
                    <h2 className="text-xl font-extrabold tracking-tight text-slate-100 uppercase">Opushire</h2>
                </Link>
                <div className="flex items-center gap-6">
                    <nav className="hidden md:flex gap-8 text-sm font-medium text-slate-400">
                        <Link href="/jobs" className="hover:text-primary transition-colors">Job Openings</Link>
                        <Link href="/register" className="hover:text-primary transition-colors">Sign Up</Link>
                    </nav>
                    <Link href="/register" className="bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 px-5 py-2 rounded-lg text-sm font-bold transition-all">
                        Join Network
                    </Link>
                </div>
            </header>
