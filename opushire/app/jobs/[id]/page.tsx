...
import { ArrowLeft, MapPin, Briefcase, IndianRupee, Clock, ChevronRight, Share2, Bookmark } from 'lucide-react';
                        ...
                        <ScrollReveal direction="right">
                            ...
                            <div className="flex flex-wrap gap-4 p-8 glass-card border-brand-violet/20 bg-brand-violet/5">
                                <div className="flex flex-col gap-1 pr-12 border-r border-white/10">
                                    ...
                                    <span className="text-lg font-bold text-brand-cyan">{job.salary}</span>
                                </div>
                                ...
                                <section>
                                    ...
                                    <ul className="space-y-3">
                                        {job.requirements.map((r, i) => (
                                            <li key={i} className="flex gap-3 text-brand-text/60">
                                                <CheckIcon className="shrink-0 text-brand-cyan w-5 h-5 mt-1" />
                                                <span>{r}</span>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className="space-y-6">
                        <ScrollReveal direction="left">
                            <div className="glass-card p-8 sticky top-32 space-y-6">
                                <Button className="w-full h-14 text-lg">Apply Now</Button>
                                ...
                                <div className="pt-6 border-t border-white/10 space-y-4">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-brand-text/80">{job.posted}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
